...
std::ifstream readerSmp;

std::list<PCMData> samplePCMList;

// Initialised (.data)

const std::string usageMsg = "Usage: gex2ps1soundexporter file [-o --out folder]";
const char posADPCMTable[5] = {0, 60, 115, 98, 122};
const char negADPCMTable[5] = {0, 0, -52, -55, -60};
